    ...
    <>
      ...
      <section className="section-pad bg-cream">
        <div className="container-wide">
          <div className="rounded-[2rem] sm:rounded-[3rem] border border-primary/5 bg-white shadow-xl overflow-hidden">
            <div className="grid lg:grid-cols-2">
              <div className="bg-primary p-8 sm:p-12 lg:p-20 text-white">
                <ContactInfo />
              </div>
